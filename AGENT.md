...
1. define the business entity/entities


2. define repository contract if needed


3. create use cases for business actions


4. implement repository/data sources in data layer


5. expose orchestration through Riverpod providers/controllers


6. keep widgets focused on rendering and interaction
