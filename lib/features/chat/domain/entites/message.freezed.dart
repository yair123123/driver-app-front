...
class _$MessageImpl implements _Message {
  const _$MessageImpl({required this.snederId, required this.text});
  ...
  @override
  String toString() {
    return 'Message(snederId: $snederId, text: $text)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.snederId, snederId) ||
                other.snederId == snederId) &&
