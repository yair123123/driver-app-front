...
mixin _$City {
  ...
  List<Neighborhood> get neighborhoods => throw _privateConstructorUsedError;
...
abstract class $CityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, double frequency, List<Neighborhood> neighborhoods});
}
...
class _$CityImpl implements _City {
  const _$CityImpl({
    ...
    required final List<Neighborhood> neighborhoods,
  ...
  @override
  List<Neighborhood> get neighborhoods {
  ...
  @override
  String toString() {
    return 'City(name: $name, frequency: $frequency, neighborhoods: $neighborhoods)';
  }
