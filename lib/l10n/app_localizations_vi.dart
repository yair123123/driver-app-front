...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String get channels_section_description =>
      'Một khu vực mới dành cho các kênh WhatsApp và Telegram với video, hình ảnh và thông tin cập nhật – tất cả nội dung thú vị nhất ở cùng một nơi.';
  ...
  String get contactUsSuccessMessage =>
      'Cảm ơn bạn! Chúng tôi đã nhận được tin nhắn của bạn và sẽ liên hệ lại với bạn sớm nhất có thể.';
  ...
  String get saveChangesMessage =>
      'Bạn có muốn lưu những thay đổi bạn đã thực hiện không?';
  ...
  String get changeCountrySubtitle =>
      'Khi bạn chọn quốc gia, tất cả nội dung trong ứng dụng sẽ cập nhật theo lựa chọn của bạn.';
  ...
  String get notificationsOffSubtitle =>
      'Có vẻ như quyền truy cập thông báo chưa được bật.';
  ...
  String get changesApplyOnNextLaunch =>
      'Những thay đổi sẽ được áp dụng vào lần ra mắt ứng dụng tiếp theo.';
  ...
  String get aiPageTitle =>
      'Sắp ra mắt: bạn sẽ có thể trò chuyện với AI của chúng tôi về tin tức!';

  @override
  String get topicsSelectionSubtitle =>
      'Chọn chủ đề hoặc chủ đề phụ bạn muốn xem trong nguồn cấp dữ liệu của mình. Bạn luôn có thể thay đổi chúng ở đây.';
  ...
  String get failed_to_load_data =>
      'Chúng tôi không thể tải dữ liệu. Vui lòng kiểm tra kết nối internet của bạn và thử lại.';
  ...
  String get notificationsPermissionRationale =>
      'Việc bật thông báo cho phép bạn cập nhật các tin tức quan trọng, cập nhật khẩn cấp và nội dung được cá nhân hóa – để bạn không bao giờ bỏ lỡ bất kỳ điều gì quan trọng đối với mình.';

  @override
  String get skipToSuggestedContent =>
      'Chuyển đến nội dung chúng tôi đã chọn cho bạn';
  ...
  String get notificationSubTitle =>
      'Bạn có thể bật thông báo bật lên cho bất kỳ chủ đề nào mà bạn quan tâm.';
  ...
  String get subTextWhatIsInteresting =>
      'Để chỉ gửi những gì thực sự phù hợp, trước tiên hãy đánh dấu những gì bạn quan tâm.';
  ...
  String get subTextNotifications =>
      'Bạn có thể bật thông báo bật lên cho mọi chủ đề mà bạn quan tâm.';
  ...
  @override
  String get welcome =>
      'Chào mừng bạn đến với ứng dụng tin tức, được cá nhân hóa dành riêng cho bạn!';
  ...
  String get chooseYourAreaHint =>
      'Chọn khu vực của bạn để nhận thông tin cập nhật tin tức được bản địa hóa';

  @override
  String get chooseYourAreaHintUnused =>
      'Chọn vùng tin tức bạn muốn.\nTrong ứng dụng, bạn cũng có thể chọn các quốc gia bổ sung.';

  @override
  String get chooseYourLangHint =>
      'Chọn ngôn ngữ của bạn, bạn luôn có thể thay đổi nó sau.';
  ...
  String get chooseTopicsHint =>
      'Chọn chủ đề mà bạn quan tâm, bạn luôn có thể thay đổi chúng trong cài đặt.';
  ...
  String get networkStatusPartialMessage =>
      'Chúng tôi có thể truy cập Internet nhưng không thể truy cập máy chủ.\\nHãy thử lại sau giây lát.';

  @override
  String get networkStatusOfflineMessage =>
      'Không có kết nối internet. Chúng tôi đang hiển thị các bài viết cũ hơn; kết nối internet để xem những câu chuyện mới nhất.';
  ...
  String get dismissibleNoticeNotificationsSubtitle =>
      'Tùy chỉnh cảnh báo của bạn một cách dễ dàng. Bật hoặc tắt thông báo đẩy cho bất kỳ chủ đề nào mà bạn quan tâm.';
  ...
  String get dismissibleNoticeLangAndAreaSubtitle =>
      'Bạn sẽ sớm có thể chọn khu vực nào trên thế giới mà bạn muốn nhận tin tức và thông tin cập nhật từ đó.';
  ...
  String get saveChangesConfirmation =>
      'Bạn có muốn lưu các thay đổi của mình không?';
  ...
  String get errorUnauthorized =>
      'Bạn không được ủy quyền. Vui lòng đăng nhập và thử lại.';
  ...
  String get errorValidation =>
      'Một số thông tin có vẻ không hợp lệ. Vui lòng xem lại và thử lại.';

  @override
  String get agreeMail =>
      'Tôi đồng ý nhận thông tin cập nhật và bản tin qua email.';
  ...
  String get discardChangesMessage =>
      'Bạn có những thay đổi chưa được lưu. Nếu bạn tiếp tục, họ sẽ bị mất.';
  ...
  String get contactUsSubtitle =>
      'Hãy liên hệ với chúng tôi bằng cách sử dụng mẫu dưới đây.';
  ...
  String get emptyResults_bottomWithTopic =>
      'Hãy thử thay đổi từ khóa của bạn hoặc chọn một chủ đề khác.';

  @override
  String get emptyResults_bottomWithoutTopic =>
      'Hãy thử thay đổi từ khóa của bạn.';
  ...
  String get errorNotModified =>
      'Không có gì thay đổi kể từ yêu cầu cuối cùng của bạn.';
  ...
  String get errorNetwork =>
      'Chúng tôi không thể truy cập mạng. Hãy kiểm tra kết nối của bạn và thử lại.';
  ...
  String get errorDataIsEmpty =>
      'Chúng tôi không thể tìm thấy bất kỳ dữ liệu nào để hiển thị.';
  ...
  String get errorConflict =>
      'Yêu cầu xung đột với dữ liệu hiện có. Vui lòng thử lại.';
  ...
  String get errorServerValidation =>
      'Máy chủ từ chối một số dữ liệu. Vui lòng xem lại và thử lại.';
  ...
  String get errorWriteFile =>
      'Chúng tôi không thể lưu tập tin. Vui lòng thử lại.';
  ...
  String get errorReadFile =>
      'Chúng tôi không thể đọc tập tin. Vui lòng thử lại.';
  ...
  String get errorFileNotFound =>
      'Chúng tôi không thể tìm thấy tập tin bạn đang tìm kiếm.';
  ...
  String get errorDatabaseConnection =>
      'Chúng tôi không thể kết nối với cơ sở dữ liệu.';
  ...
  String get errorSecureStorageRead =>
      'Chúng tôi không thể đọc từ bộ nhớ an toàn.';
  ...
  String get errorSecureStorageWrite =>
      'Chúng tôi không thể ghi vào bộ nhớ an toàn.';
  ...
  String get errorSecureStorageClear =>
      'Chúng tôi không thể xóa bộ nhớ an toàn.';
  ...
  String get errorEmptyResult =>
      'Chúng tôi không thể tìm thấy bất kỳ kết quả nào.';
